 ...
 * Must be serializable to be transmitted across the RMI network.
 */
public class Media implements Serializable {
    ...
    public void setAdultContent(boolean flag) { this.isAdultContent = flag; }
    ...
    public void loadCover(String path) {
        this.cover = new ImageIcon(Toolkit.getDefaultToolkit().createImage(path));
    }
