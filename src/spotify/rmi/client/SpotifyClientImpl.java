...
public class SpotifyClientImpl extends UnicastRemoteObject implements SpotifyClient {
    ...
    // Secure constructor required for SSL RMI Callbacks
    public SpotifyClientImpl(SslRMIClientSocketFactory csf, SslRMIServerSocketFactory ssf) throws RemoteException {
        super(0, csf, ssf); // 0 = dynamic port allocation
    }
